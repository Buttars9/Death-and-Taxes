...
export default function RefundEstimate() {
  const { parsedFields, answers } = useWizardStore();
  const fields = { ...answers, ...parsedFields };
  
  const standardDeduction = fields.filingStatus === 'married_filing_jointly' ? 31500 : 13850;

  const refund = {
    state: fields.residentState || 'N/A',
    filingStatus: fields.filingStatus || 'N/A',
    ...
    deduction: fields.deductionType === 'standard' ? standardDeduction : fields.deductions?.length || 0,
